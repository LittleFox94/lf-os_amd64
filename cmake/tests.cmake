...
if(${BUILD_TESTING})
    set(CMAKE_C_FLAGS_PROFILE   "-g -O0 --coverage")
    set(CMAKE_CXX_FLAGS_PROFILE "-g -O0 --coverage")
    ...
    add_custom_target(tests DEPENDS test-kernel runtime-tests test-tinystl test-liblfos test-lib9p)
